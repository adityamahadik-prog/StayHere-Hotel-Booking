    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
        ...
        <div className='flex flex-col lg:flex-row mt-6 gap-6'>
            ...
            <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
                {room?.images.length > 1 && room.images.map((images, index)=>(
                    <img onClick={()=> setMainImage(images)}
                     key={index} src={images} alt="Room Image" 
                     className={`w-full rounded-xl shadow-md object-cover 
                        cursor-pointer ${mainImage === images && 'outline-3 outline-orange-500'}`} />
                ))}
            </div>
        </div>
        ...
        mx-auto mt-16 max-w-6xl'>
            ...
            md:items-center gap4 md:gap-10 text-gray-500'>
